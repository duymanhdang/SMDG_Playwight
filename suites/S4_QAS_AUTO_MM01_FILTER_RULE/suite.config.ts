...
export const suiteConfig = {
  ...
  accounts: {
    ...
    approver2: { user: process.env.APPROVER2_USER || '', pass: process.env.APPROVER2_PASS || '' },
    admin: { user: process.env.ADMIN_USER || '', pass: process.env.ADMIN_PASS || '' },
  },

  templates: {
    AUTO_MM01_FILTER_RULE: { name: 'AUTO_MM01_FILTER_RULE', objectType: 'Product' },
  },

  sourceCRs: { default: 'CR0000024321' },
